package org.osmf.smil.loader
{
	...
	public class AudioNetStreamSeekTrait extends SeekTrait
	{
		public function AudioNetStreamSeekTrait(arg0:TimeTrait, loadTrait:LoadTrait, netStream:NetStream, videoSurface:VideoSurface=null)
		{
			super(arg0);
		...
		override protected function seekingChangeEnd(time:Number):void
		{
			...
			if (seeking == true &&  videoSurface != null)
			{
				...
				if (	nsTimeTrait != null 
					&&	nsTimeTrait.currentTime >= nsTimeTrait.duration
				)
				{
					videoSurface.clear();
				}
