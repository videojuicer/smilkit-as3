...
package org.osmf.smil
{
	...
	public class SMILPluginInfo extends PluginInfo
	{
		...
		public function SMILPluginInfo()
		{
			...
			_smilMediaItem = new MediaFactoryItem("org.osmf.smil.SMILPluginInfo", new SMILLoader().canHandleResource, createSMILProxyElement);
			items.push(_smilMediaItem);
		...
		override public function initializePlugin(resource:MediaResourceBase):void
		{
			...
			mediaFactory.addItem(_smilMediaItem);
		}
		
		private var mediaFactory:MediaFactory;
		private var _smilMediaItem:MediaFactoryItem;
	}
}
